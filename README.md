...
Principal component analysis (PCA) was performed using the variance-stabilizing transformed (VST) count data generated by DESeq2 to assess sample-to-sample variation 
