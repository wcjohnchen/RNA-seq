...
Redundant GO terms were reduced using `simplify()` from the `clusterProfiler` R package with Wang semantic similarity (cutoff = 0.7).  The most significant representative term was retained 
